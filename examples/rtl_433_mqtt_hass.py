...
def publish_config(mqttc, topic, model, object_id, mapping, key=None):
    ...
    # get the manufacturer and the manufacturer from the rtl_433 model attribute
    # this is so that hassio correctly displays the manufacturer, instead of "rtl_433"
    try:
